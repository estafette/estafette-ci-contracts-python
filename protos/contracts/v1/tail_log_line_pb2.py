...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='protos/contracts.v1/tail_log_line.proto',
...
_TAILLOGLINE.fields_by_name['log_line'].message_type = protos_dot_contracts_dot_v1_dot_build__log__line__pb2._BUILDLOGLINE
_TAILLOGLINE.fields_by_name['image'].message_type = protos_dot_contracts_dot_v1_dot_build__log__step__docker__image__pb2._BUILDLOGSTEPDOCKERIMAGE
...
TailLogLine = _reflection.GeneratedProtocolMessageType('TailLogLine', (_message.Message,), dict(
  ...
  __module__ = 'protos.contracts.v1.tail_log_line_pb2'
