...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='protos/contracts.v1/release_params_config.proto',
...
ReleaseParamsConfig = _reflection.GeneratedProtocolMessageType('ReleaseParamsConfig', (_message.Message,), dict(
  ...
  __module__ = 'protos.contracts.v1.release_params_config_pb2'
