...
from protos.contracts.v1 import git_author_pb2 as protos_dot_contracts_dot_v1_dot_git__author__pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='protos/contracts.v1/git_commit.proto',
...
_GITCOMMIT.fields_by_name['author'].message_type = protos_dot_contracts_dot_v1_dot_git__author__pb2._GITAUTHOR
...
GitCommit = _reflection.GeneratedProtocolMessageType('GitCommit', (_message.Message,), dict(
  ...
  __module__ = 'protos.contracts.v1.git_commit_pb2'
