...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='protos/manifest.v1/estafette_trigger_release_action.proto',
  package='manifest.v1',
  syntax='proto3',
...
EstafetteTriggerReleaseAction = _reflection.GeneratedProtocolMessageType('EstafetteTriggerReleaseAction', (_message.Message,), dict(
  ...
  __module__ = 'protos.manifest.v1.estafette_trigger_release_action_pb2'
