...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='protos/manifest.v1/estafette_release_action.proto',
  package='manifest.v1',
  syntax='proto3',
...
EstafetteReleaseAction = _reflection.GeneratedProtocolMessageType('EstafetteReleaseAction', (_message.Message,), dict(
  ...
  __module__ = 'protos.manifest.v1.estafette_release_action_pb2'
