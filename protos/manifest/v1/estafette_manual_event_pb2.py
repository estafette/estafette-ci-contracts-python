...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='protos/manifest.v1/estafette_manual_event.proto',
  package='manifest.v1',
  syntax='proto3',
...
EstafetteManualEvent = _reflection.GeneratedProtocolMessageType('EstafetteManualEvent', (_message.Message,), dict(
  ...
  __module__ = 'protos.manifest.v1.estafette_manual_event_pb2'
