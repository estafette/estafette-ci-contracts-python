...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='protos/manifest.v1/estafette_version_params.proto',
  package='manifest.v1',
  syntax='proto3',
...
EstafetteVersionParams = _reflection.GeneratedProtocolMessageType('EstafetteVersionParams', (_message.Message,), dict(
  ...
  __module__ = 'protos.manifest.v1.estafette_version_params_pb2'
