...
from protos.manifest.v1 import string_or_string_array_pb2 as protos_dot_manifest_dot_v1_dot_string__or__string__array__pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='protos/manifest.v1/estafette_semver_version.proto',
  package='manifest.v1',
  syntax='proto3',
...
_ESTAFETTESEMVERVERSION.fields_by_name['release_branch'].message_type = protos_dot_manifest_dot_v1_dot_string__or__string__array__pb2._STRINGORSTRINGARRAY
...
EstafetteSemverVersion = _reflection.GeneratedProtocolMessageType('EstafetteSemverVersion', (_message.Message,), dict(
  ...
  __module__ = 'protos.manifest.v1.estafette_semver_version_pb2'
