...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='protos/manifest.v1/estafette_release_trigger.proto',
  package='manifest.v1',
  syntax='proto3',
...
EstafetteReleaseTrigger = _reflection.GeneratedProtocolMessageType('EstafetteReleaseTrigger', (_message.Message,), dict(
  ...
  __module__ = 'protos.manifest.v1.estafette_release_trigger_pb2'
