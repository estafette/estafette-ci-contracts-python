...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='protos/manifest.v1/estafette_pipeline_trigger.proto',
  package='manifest.v1',
  syntax='proto3',
...
EstafettePipelineTrigger = _reflection.GeneratedProtocolMessageType('EstafettePipelineTrigger', (_message.Message,), dict(
  ...
  __module__ = 'protos.manifest.v1.estafette_pipeline_trigger_pb2'
