...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='estafette/ci/manifest/v1/estafette_version_params.proto',
...
_ESTAFETTEVERSIONPARAMS = _descriptor.Descriptor(
  ...
  full_name='estafette.ci.manifest.v1.EstafetteVersionParams',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='auto_increment', full_name='estafette.ci.manifest.v1.EstafetteVersionParams.auto_increment', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='branch', full_name='estafette.ci.manifest.v1.EstafetteVersionParams.branch', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='revision', full_name='estafette.ci.manifest.v1.EstafetteVersionParams.revision', index=2,
...
EstafetteVersionParams = _reflection.GeneratedProtocolMessageType('EstafetteVersionParams', (_message.Message,), {
  'DESCRIPTOR' : _ESTAFETTEVERSIONPARAMS,
  '__module__' : 'estafette.ci.manifest.v1.estafette_version_params_pb2'
