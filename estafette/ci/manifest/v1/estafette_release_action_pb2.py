...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='estafette/ci/manifest/v1/estafette_release_action.proto',
...
_ESTAFETTERELEASEACTION = _descriptor.Descriptor(
  ...
  full_name='estafette.ci.manifest.v1.EstafetteReleaseAction',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='estafette.ci.manifest.v1.EstafetteReleaseAction.name', index=0,
...
EstafetteReleaseAction = _reflection.GeneratedProtocolMessageType('EstafetteReleaseAction', (_message.Message,), {
  'DESCRIPTOR' : _ESTAFETTERELEASEACTION,
  '__module__' : 'estafette.ci.manifest.v1.estafette_release_action_pb2'
