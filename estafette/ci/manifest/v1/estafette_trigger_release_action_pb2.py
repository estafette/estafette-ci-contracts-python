...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='estafette/ci/manifest/v1/estafette_trigger_release_action.proto',
...
_ESTAFETTETRIGGERRELEASEACTION = _descriptor.Descriptor(
  ...
  full_name='estafette.ci.manifest.v1.EstafetteTriggerReleaseAction',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='target', full_name='estafette.ci.manifest.v1.EstafetteTriggerReleaseAction.target', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='action', full_name='estafette.ci.manifest.v1.EstafetteTriggerReleaseAction.action', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='version', full_name='estafette.ci.manifest.v1.EstafetteTriggerReleaseAction.version', index=2,
...
EstafetteTriggerReleaseAction = _reflection.GeneratedProtocolMessageType('EstafetteTriggerReleaseAction', (_message.Message,), {
  'DESCRIPTOR' : _ESTAFETTETRIGGERRELEASEACTION,
  '__module__' : 'estafette.ci.manifest.v1.estafette_trigger_release_action_pb2'
