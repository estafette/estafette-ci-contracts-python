...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='estafette/ci/contracts/v1/container_repository_credential_config.proto',
...
_CONTAINERREPOSITORYCREDENTIALCONFIG = _descriptor.Descriptor(
  ...
  full_name='estafette.ci.contracts.v1.ContainerRepositoryCredentialConfig',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='repository', full_name='estafette.ci.contracts.v1.ContainerRepositoryCredentialConfig.repository', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='username', full_name='estafette.ci.contracts.v1.ContainerRepositoryCredentialConfig.username', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='password', full_name='estafette.ci.contracts.v1.ContainerRepositoryCredentialConfig.password', index=2,
...
ContainerRepositoryCredentialConfig = _reflection.GeneratedProtocolMessageType('ContainerRepositoryCredentialConfig', (_message.Message,), {
  'DESCRIPTOR' : _CONTAINERREPOSITORYCREDENTIALCONFIG,
  '__module__' : 'estafette.ci.contracts.v1.container_repository_credential_config_pb2'
