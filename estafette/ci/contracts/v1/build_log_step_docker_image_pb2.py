...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='estafette/ci/contracts/v1/build_log_step_docker_image.proto',
...
_BUILDLOGSTEPDOCKERIMAGE = _descriptor.Descriptor(
  ...
  full_name='estafette.ci.contracts.v1.BuildLogStepDockerImage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='estafette.ci.contracts.v1.BuildLogStepDockerImage.name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='tag', full_name='estafette.ci.contracts.v1.BuildLogStepDockerImage.tag', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='is_pulled', full_name='estafette.ci.contracts.v1.BuildLogStepDockerImage.is_pulled', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='image_size', full_name='estafette.ci.contracts.v1.BuildLogStepDockerImage.image_size', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='pull_duration', full_name='estafette.ci.contracts.v1.BuildLogStepDockerImage.pull_duration', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='error', full_name='estafette.ci.contracts.v1.BuildLogStepDockerImage.error', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='is_trusted', full_name='estafette.ci.contracts.v1.BuildLogStepDockerImage.is_trusted', index=6,
...
BuildLogStepDockerImage = _reflection.GeneratedProtocolMessageType('BuildLogStepDockerImage', (_message.Message,), {
  'DESCRIPTOR' : _BUILDLOGSTEPDOCKERIMAGE,
  '__module__' : 'estafette.ci.contracts.v1.build_log_step_docker_image_pb2'
